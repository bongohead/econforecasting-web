...
\t";
        // line 12
        $this->loadTemplate("fc-macro-sidebar.html", "nc-gdp.html", 12)->display($context);
        // line 13
...
\t\t\t
\t\t\t\t<div class=\"card border-secondary border-2 m-2 col-xl-8 col-lg-10 col-sm-12 bg-white\">
