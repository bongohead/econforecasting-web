...
/* csm-sidebar.html */
class __TwigTemplate_69e223199d2c7153611275729c7afa2e715e9fd0e99fd4bffcac36109b1790ef extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<nav class=\"sidebar col-lg-auto d-none d-lg-block px-0 py-2\" id=\"sidebar\"> <!-- Hide Sidebar for XS to M Devices -->
...
";
    ...
    {
        return new Source("<nav class=\"sidebar col-lg-auto d-none d-lg-block px-0 py-2\" id=\"sidebar\"> <!-- Hide Sidebar for XS to M Devices -->
\t<div class=\"nav flex-column\">
\t\t<a href=\"#t\" data-bs-toggle=\"collapse\" class=\"nav-link\">
\t\t\t<div>
\t\t\t\t<span>Treasury Yield Forecast</span>
...
", "csm-sidebar.html", "/var/www/econforecasting.com/public/templates/csm-sidebar.html");
    }
}
