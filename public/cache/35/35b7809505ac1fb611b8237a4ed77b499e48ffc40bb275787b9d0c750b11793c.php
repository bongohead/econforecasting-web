...
\t\t\t\t<div class=\"row g-3\">
\t\t\t\t\t<!-- GDP Card -->
\t\t\t\t\t<div class=\"col-12 border-0 p-0 pe-lg-4\">
...
\t\t\t\t\t\t\t\t\t\t  <label class=\"input-group-text\">Frequency</label>
\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-select form-select-sm select-month me-2\">
\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"q\" selected>Quarterly</option><option value=\"m\" >Monthly</option>
\t\t\t\t\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t<!-- Benchmark Rates -->
\t\t\t\t\t<div class=\"col-12 border-0 p-0 pe-lg-4\">
\t\t\t\t\t\t<div class=\"card shadow\" data-ref-dispgroup=\"Benchmark Rates\">
\t\t\t\t\t\t\t<div class=\"card-header\">
\t\t\t\t\t\t\t\t<div class=\"row flex-between-center\">
\t\t\t\t\t\t\t\t\t<div class=\"col-auto\">
\t\t\t\t\t\t\t\t\t\t<span class=\"mb-0 fw-bolder\" style=\"font-size:.9rem\">Benchmark Rates</span>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"col-auto d-flex\">
\t\t\t\t\t\t\t\t\t\t<div class=\"input-group input-group-sm\">
\t\t\t\t\t\t\t\t\t\t  <label class=\"input-group-text\">Frequency</label>
