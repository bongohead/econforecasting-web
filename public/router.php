...
if (isset($_POST) && isset($_POST['isAjax'])) {
	...
	routePage(
		...
		*/	
			...
			['template' => 'forecast-rates', 'request' => ['forecast-mort15y'], 'title' => '15-Year Mortgage Rate | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
			...
			['template' => 'forecast-rates', 'request' => ['forecast-t03m'], 'title' => '3 Month Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
			['template' => 'forecast-rates', 'request' => ['forecast-t06m'], 'title' => '6 Month Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
			['template' => 'forecast-rates', 'request' => ['forecast-t01y'], 'title' => '1 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
			['template' => 'forecast-rates', 'request' => ['forecast-t02y'], 'title' => '2 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
			['template' => 'forecast-rates', 'request' => ['forecast-t05y'], 'title' => '5 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
			['template' => 'forecast-rates', 'request' => ['forecast-t10y'], 'title' => '10 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'forecast-varname']],
