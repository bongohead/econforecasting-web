...
if (isset($_POST) && isset($_POST['isAjax'])) {
	...
	routePage(
		...
		*/	
			['template' => 'home', 'request' => ['', 'home'], 'title' => 'The Center for Macroeconomic Forecasting & Insights | econforecasting.com', 'description' => 'Get aggregated macroeconomic data, forecasts, models, and insights including GDP forecasts, interest rate forecasts, and Treasury yield forecasts.', 'models' => [], 'js' => ['init', 'home']],
			
			['template' => 'forecast-rates', 'request' => ['forecast-sofr', 'fc-rates-sofr'], 'title' => 'SOFR Forecasts | Economic Forecasts | econforecasting.com', 'description' => 'Our model provides monthly forecasts of the SOFR rate using a futures market driven forecast model.', 'models' => [], 'js' => ['init', 'forecast-varname']],
			['template' => 'forecast-rates', 'request' => ['forecast-ffr', 'fc-rates-ffr'], 'title' => 'FFR Forecasts | Economic Forecasts | econforecasting.com', 'description' => 'Our model provides monthly forecasts of the federal funds rate using a futures market driven forecast model.', 'models' => [], 'js' => ['init', 'forecast-varname']],
