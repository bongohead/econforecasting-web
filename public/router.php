...
if (isset($_POST) && isset($_POST['isAjax'])) {
	...
	routePage(
		...
		routes: [
			...
			['template' => 'rates-model-treasury', 'request' => ['rates-model-treasury-2y'], 'title' => '2 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'rates-model-treasury']],
			['template' => 'rates-model-treasury', 'request' => ['rates-model-treasury-5y'], 'title' => '5 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'rates-model-treasury']],
			['template' => 'rates-model-treasury', 'request' => ['rates-model-treasury-10y'], 'title' => '10 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'rates-model-treasury']],
			['template' => 'rates-model-treasury', 'request' => ['rates-model-treasury-20y'], 'title' => '20 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'rates-model-treasury']],
			['template' => 'rates-model-treasury', 'request' => ['rates-model-treasury-30y'], 'title' => '30 Year Treasury Yield Forecast | econforecasting.com', 'models' => [], 'js' => ['init', 'rates-model-treasury']],
