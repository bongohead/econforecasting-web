...
if (isset($_POST) && isset($_POST['isAjax'])) {
	...
	routePage(
		...
		routes: [
			...
			['template' => 'rates-model-treasury', 'request' => ['rates-model-treasury-3m', 'rates-model-treasury-6m'], 'title' => 'Treasury Yield Forecasts | CMEFI', 'models' => [], 'js' => ['init', 'rates-model-treasury']],
		],
