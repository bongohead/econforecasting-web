...
if (isset($_POST) && isset($_POST['isAjax'])) {
	...
	routePage(
		...
		$routes = [
			...
			['template' => 'ac-regions-hm', 'request' => ['ac-regions-hm'], 'title' => 'Treasury Yield Forecasts', 'models' => [], 'js' => ['init', 'ac-regions-hm']],
			...
			['template' => 'fc-rates-tcurve', 'request' => ['fc-rates-tcurve'], 'title' => 'Federal Funds Rate Forecasts', 'models' => [], 'js' => ['init', 'fc-rates-tcurve']],
