	...
	const o = {
        ...
        title: {
			...
			text: 
				...
				'<div style="vertical-align:middle;display:inline"><span class="font-family-logo fw-medium" style="vertical-align:middle;font-size:1.3rem;color:rgb(15, 17, 23)">' + fullname + ' Forecast</span></div>',
        },
		caption: {
			useHTML: true,
