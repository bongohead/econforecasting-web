...
/*** Get relevant data ***/
function getFcHistory(freq) {
	const dfd = $.Deferred();
	getAJAX('getFcHistory', toScript = ['fcHistory'], fromAjax = {varname: 'effr', freq: 'm'}).done(function(ajaxRes) {
